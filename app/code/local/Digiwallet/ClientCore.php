...
require_once (BP . DS . 'app' . DS . 'code' . DS . 'local' . DS . "Digiwallet" . DS . "client" . DS . "vendor" . DS . "autoload.php");
/**
...
class ClientCore
{
    ...
    protected function clientStartTransaction($apiKey, $params)
    {
        ...
        $digiwalletApi = new Client(self::DIGIWALLET_API_URL);
        $request = new CreateTransaction($digiwalletApi, $params);
     ...
     * @param $apiKey
     * @param $transactionID
     * @return bool|\Digiwallet\client\src\Response\CheckTransaction
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
