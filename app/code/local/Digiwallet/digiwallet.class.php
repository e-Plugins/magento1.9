...
{
    const APP_ID = 'dw_magento1.x_1.0.8';
    ...
    public function startPayment()
    {
        ...
        if (($this->payMethod == "IDE") && (! $this->bankId)) {
            ...
            //return false;
            $this->bankId = ""; // Change to allow user to select bank in bank list screen instead of throwing error message
        }
