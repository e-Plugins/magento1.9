...
class Digiwallet_Ideal_Block_Payment_Form_Ideal extends Mage_Payment_Block_Form_Cc
{
    ...
    public function getBanks()
    {
        ...
        $digiWallet = new DigiwalletCore($this->_tp_method, Mage::getStoreConfig('payment/ideal/rtlo'), "f8ca4794a1792886bb88060ca0685c1e", $language, false);
        return $digiWallet->getBankList();
    }
}
